...
export const metadata: Metadata = {
  title: 'О нас | NAKORT — Теннисный клуб',
  description: 'О клубе NAKORT: комьюнити людей, увлечённых большим теннисом и яркой жизнью.',
};
    ...
    <>
      ...
      <main className="main">
        <section className="container" style={{ paddingTop: 120, paddingBottom: 120, textAlign: 'center' }}>
          <h1 style={{ marginBottom: 24 }}>О нас</h1>
