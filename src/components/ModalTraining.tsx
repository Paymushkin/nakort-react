          ...
          <div className={styles.modalSection}>
            ...
            <div className={styles.modalField}>
              <div className={styles.modalSelectWrapper}>
                <select className={styles.modalSelect} id="sport-training" name="sport" required defaultValue="">
            ...
            <div className={styles.modalField}>
              <div className={styles.modalSelectWrapper}>
                <select className={styles.modalSelect} id="format-training" name="format" required defaultValue="">
                  <option value="" disabled>
                    Выберите формат
                  </option>
